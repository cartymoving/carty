...
const MobileQuoteBtn = () => {
  ...
  useEffect(() => {
   ...
   return (
     <>
       <button onClick={toggleOverlay} className='quote text-xs flex items-center w-full justify-center lg:hidden gap-2 py-[12px] bg-mygreen mr-4 hover:bg-mywhite border-mygreen border-2 rounded-md font-Montserrat text-mywhite hover:text-mygreen font-bold transition-all'>
