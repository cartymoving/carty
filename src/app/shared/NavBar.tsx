  ...
  return (
    <nav className='top-8 absolute w-full h-fit px-[6vw] xl:px-[10vw] z-20'>
      <div className='bg-mywhite rounded-lg px-12 py-2 md:py-5 flex items-center text-nowrap justify-center lg:justify-between w-full nav'>
        ...
        <div className='gap-6 xl:gap-12 font-medium forHoverParent text-base 2xl:text-xl lg:flex hidden'>
          <Link href="#" className='forHover text-mygreen transition-all'>Home</Link>
          <Link href="#" className='forHover transition-all'>About Us</Link>
          <Link href="#" className='forHover transition-all'>Moving Tips</Link>
          <Link href="#" className='forHover transition-all'>Rates</Link>
          <Link href="#" className='forHover transition-all'>Client Reviews</Link>
        </div>

        <Link href="#" className='quote lg:flex hidden gap-2 px-4 py-2 xl:py-[15px] xl:px-8 bg-mygreen hover:bg-mywhite border-mygreen border-2 rounded-md font-Hind text-mywhite hover:text-mygreen font-bold transition-all'>
