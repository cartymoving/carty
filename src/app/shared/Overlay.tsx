...
const Overlay:React.FC<ActionProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <>
      {isOpen ? (
        <div className='fixed overlay flex items-center justify-center -top-8 left-0 w-screen h-screen bg-[rgba(10, 37, 19, 0.70)]'>
          <div className={`bg-mywhite w-[800px] h-[629px] rounded-lg container py-16 px-32 flex flex-col relative`}>
            <div className='absolute top-6 right-6 cursor-pointer' onClick={goBack}>
            ...
            <div className={`flex justify-between items-center w-[264px] mb-12 mx-auto ${currentPage > 3 ? "-translate-x-[1000px]" : ""} transition-all`}>
              ...
              <path d="M1 4.5L3.71186 8L9 1" stroke="#4C9A2A" stroke-width="2"/>
              </svg>) : <p>1</p>}
              </div>
            ...
            <form className='flex parent absolute h-fit mt-[72px]'>
              <div className={`first inline-block relative w-[528px] transition-all mr-[500px] ${currentPage == 1 ? "translate-x-2" : "-translate-x-[1000px]"}`}>
                <h1 className='font-Montserrat font-bold text-2xl text-center'>Step 1: Moving Property</h1>
                <p className='font-Hind font-medium text-xl text-center mt-4 mb-20'>Select the type of property you are moving.</p>
                <div className='grid grid-cols-2 grid-rows-2 gap-4'>
                  <label className={`flex px-6 py-3 items-center container border-[1px] rounded-[4px] border-mygreen cursor-pointer ${selectedProperty === 'Private House' ? 'bg-mygreen text-mywhite' : ''}`}>
                    ...
                    <span className="text-xl">Private House</span>
                  </label>
                  <label className={`flex px-6 py-3 items-center container border-[1px] rounded-[4px] border-mygreen cursor-pointer ${selectedProperty === 'Office/Commercial' ? 'bg-mygreen text-mywhite' : ''}`}>
                    ...
                    <span className="text-xl">Office/Commercial</span>
                  </label>
                  ...
                  <input
                    type="text"
                    placeholder='Other'
                    className='text-xl px-6 py-3 container border-[1px] rounded-[4px] border-mygreen'
                    value={otherText}
                    name="type of property"
              ...
              <div className={`second inline-block w-[528px] transition-all mr-[500px] relative ${currentPage == 2 ? "-translate-x-[1008px]" : ""} ${currentPage > 2 ? "-translate-x-[2000px]" : ""}`}>
                <h1 className='font-Montserrat font-bold text-2xl text-center'>Step 2: Number of Rooms</h1>
                <p className='font-Hind font-medium text-xl text-center mt-4 mb-12'>How many rooms are being moved?</p>
                <div className='grid grid-cols-2 grid-rows-3 gap-4'>
                  <label className={`flex px-6 py-3 items-center container border-[1px] rounded-[4px] border-mygreen cursor-pointer ${selectedProperty === 'Studio' ? 'bg-mygreen text-mywhite' : ''}`}>
                    <input 
                      type="radio" 
                      value="Studio" 
                      className="hidden" 
                  ...
                  <label className={`flex px-6 py-3 items-center container border-[1px] rounded-[4px] border-mygreen cursor-pointer ${selectedProperty === '1 Bedroom' ? 'bg-mygreen text-mywhite' : ''}`}>
                    <input 
                    type="radio" 
                    value="1 Bedroom"
                    className="hidden" 
                    ...
                    <span className="text-xl">1 Bedroom</span>
                  </label>
                  <label className={`flex px-6 py-3 items-center container border-[1px] rounded-[4px] border-mygreen cursor-pointer ${selectedProperty === '2 Bedroom' ? 'bg-mygreen text-mywhite' : ''}`}>
                    <input 
                    type="radio" 
                    value="2 Bedroom" 
                    className="hidden" 
                    ...
                    <span className="text-xl">2 Bedroom</span>
                  </label>
                  <label className={`flex px-6 py-3 items-center container border-[1px] rounded-[4px] border-mygreen cursor-pointer ${selectedProperty === '3 Bedroom' ? 'bg-mygreen text-mywhite' : ''}`}>
                    <input 
                    type="radio" 
                    value="3 Bedroom" 
                    className="hidden" 
                    ...
                    <span className="text-xl">3 Bedroom</span>
                  </label>
                  <label className={`flex px-6 py-3 items-center container border-[1px] rounded-[4px] border-mygreen cursor-pointer ${selectedProperty === '4+ Bedroom' ? 'bg-mygreen text-mywhite' : ''}`}>
                    <input 
                    type="radio" 
                    value="4+ Bedroom" 
                    className="hidden" 
                    ...
                    <span className="text-xl">4+ Bedroom</span>
                  </label>
                  <input
                    type="text"
                    placeholder='Other'
              ...
              <div className={`third inline-block w-[528px] transition-all relative ${currentPage == 3 ? "-translate-x-[2047px]" : ""} ${currentPage > 3 ? "-translate-x-[3000px]" : ""}`}>
                <h1 className='font-Montserrat font-bold text-2xl text-center'>Step 3: Moving Details</h1>
                <p className='font-Hind font-medium text-xl text-center mt-4 mb-12'>Let our team know more details.</p>
                <div className='grid grid-cols-2 grid-rows-3 gap-4'>
                  <input type="text" name="Moving Details" placeholder='Moving From *' className='text-xl px-6 py-3 container border-[1px] rounded-[4px] border-mygreen'/>
                  <input type="text" name="Moving Details" placeholder='Moving To *' className='text-xl px-6 py-3 container border-[1px] rounded-[4px] border-mygreen'/>
                  <input type="date" name="Moving Details" className='text-xl px-6 py-3 container border-[1px] rounded-[4px] border-mygreen text-gray-400'/>
                  <input
                    type="text"
                    placeholder='Email *'
                    name="number of rooms"
              ...
              <div className={`final inline-block w-[528px] transition-all relative ${currentPage == 4 ? "-translate-x-[2590px]" : ""}`}>
                <svg width="168" height="168" viewBox="0 0 168 168" fill="none" xmlns="http://www.w3.org/2000/svg" className='mx-auto -translate-y-12'>
                  <circle cx="84" cy="84" r="78" transform="rotate(-90 84 84)" fill="#F6F9FC" stroke="#4C9A2A" strokeWidth="12"/>
                  <path d="M57 84L75.6441 108L112 60" stroke="#4C9A2A" strokeWidth="13.7439"/>
                </svg>
                <h1 className='font-Montserrat font-bold text-2xl text-center'>Thank You for Requesting a Quote!</h1>
                <p className='font-Hind font-medium text-xl text-center mt-4 mb-6'>Your request has been successfully submitted. A member of our<br/> team will review your details and get in touch with you.</p>
