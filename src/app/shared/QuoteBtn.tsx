...
const QuoteBtn = () => {
  ...
  return (
    <>
      <Link href="#" onClick={toggleOverlay} className='quote lg:flex hidden gap-2 px-4 py-2 xl:py-[15px] xl:px-7 bg-mygreen mr-4 hover:bg-mywhite border-mygreen border-2 rounded-md font-Montserrat text-mywhite hover:text-mygreen font-bold transition-all'>
