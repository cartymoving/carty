    ...
    <section className='mt-[33vh] h-fit w-screen px-4 md:px-[10vw]'>
      ...
      <div className='flex flex-col items-center gap-12 mt-16'>
        ...
        <div className='flex md:flex-row flex-col w-full items-center md:items-start justify-center gap-12'>
          <div className='container bg-mywhite py-7 px-4 xl:px-12 md:w-[48%] rounded-xl'>
