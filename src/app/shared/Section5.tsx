...
const Section5 = () => {
  ...
  const reviews = [
    ...
    { id: 8, review: "We were impressed with the level of service provided by carty movers. They handled our delicate items with great care and ensured everything arrived safely. Thank you!", author: "THE BROWN FAMILY", stars: 5 },
    { id: 9, review: "Our office move was seamless thanks to carty moving company. They were organized, professional, and got us set up in our new space in no time. Fantastic service!", author: "THE BIG GUY COMPANY", stars: 4 },
    { id: 10, review: "Moving can be so stressful, but carty movers made it easy. They were professional, efficient, and took great care of our belongings. We highly recommend their services!", author: "ANNA R.", stars: 5 },
    { id: 11, review: "Carty moving company exceeded our expectations. Their team was friendly, professional, and handled our move with ease. We are very grateful for their excellent service.", author: "THE THOMPSON FAMILY", stars: 5 },
    { id: 12, review: "Carty movers provided exceptional service during our move. They were quick, efficient, and treated our belongings as if they were their own. Will definitely use them again!", author: "JOHN K.", stars: 4 }
  ];
